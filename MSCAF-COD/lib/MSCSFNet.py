...
class CSFF(nn.Module):
    def __init__(self, hidden_channels, out_channels):
        ...
        self.cat2 = BasicConv2d(hidden_channels * 2,
...
class DenseInteractionDecoder(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        x3_1 = self.conv_upsample2(self.upsample(
            x2_1)) * self.conv_upsample3(self.upsample(x2)) * x3
        x4_1 = self.conv_upsample3(self.upsample(
            x3_1)) * self.conv_upsample7(self.upsample(x3)) * x4
...
class asyConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, padding_mode='zeros', deploy=False):
        ...
        if deploy:
            ...
            ver_pad_or_crop = (center_offset_from_origin_border +
                               1, center_offset_from_origin_border)
...
class ERF(nn.Module):
    def __init__(self, x, y):
        ...
        self.asyConv = asyConv(in_channels=x, out_channels=y, kernel_size=3, stride=1,
        ...
        self.atrConv = nn.Sequential(
            nn.Conv2d(x, y, kernel_size=3, dilation=3, padding=3,
                      stride=1), nn.BatchNorm2d(y), nn.PReLU()
        )
...
class Network(nn.Module):
    def __init__(self, channel=64):
        ...
        path = "/Users/marla/Documents/GitHub/mscaf-mit-video-funtionen-/MSCAF-COD/pvt_v2_b2.pth"
